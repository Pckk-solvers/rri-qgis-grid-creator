...
def run_full_pipeline(
    ...
    input_asc = mesh_dir / "domain_mesh.asc"
...
# 例：実行の仕方
# python run_full_pipeline.py --domain domain.shp --basin basin.shp --cells_x 100 --cells_y 100 --points points.shp --standard-mesh standard_mesh.shp